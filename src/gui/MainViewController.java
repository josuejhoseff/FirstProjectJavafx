...
public class MainViewController implements Initializable {
	...
	private synchronized <T>void loadView(String absoluteName, Consumer<T> initilializeAction) { //synchronized para este elemento rodar sem interrupção
		try {
			...
			initilializeAction.accept(controller);
