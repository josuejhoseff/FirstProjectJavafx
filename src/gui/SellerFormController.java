...
public class SellerFormController implements Initializable {
	...
	private Seller getFormData() {
		...
		Instant instant = Instant.from(dpBirthDate.getValue().atStartOfDay(ZoneId.systemDefault())); //pegar o valor que esta no datepieacker
	...
	private void setErroMessages(Map<String, String> erros) {
		Set<String> fields = erros.keySet();					
			labelErroName.setText(fields.contains("name") ? erros.get("name") : ""); 
				//entre parenteses: if condição for verdadeira faça isso, do contrario (:) faça isso;
